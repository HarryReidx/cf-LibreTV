# HarryReid's - 免费在线视频搜索与观看平台

<div align="center">
  <img src="https://images.icon-icons.com/38/PNG/512/retrotv_5520.png" alt="HarryReid's Logo" width="120">
  <br>
...
HarryReid's 是一个轻量级、免费的在线视频搜索与观看平台，提供来自多个视频源的内容搜索与播放服务。无需注册，即开即用，支持多种设备访问。项目结合了前端技术和后端代理功能，可部署在支持服务端功能的各类网站托管服务上。
...
选择以下任一平台，点击一键部署按钮，即可快速创建自己的 HarryReid's 实例：

[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https%3A%2F%2Fgithub.com%2FLibreSpark%2FHarryReid's) [![Deploy to Netlify](https://www.netlify.com/img/deploy/button.svg)](https://app.netlify.com/start/deploy?repository=https://github.com/LibreSpark/HarryReid's)
...
services:
  HarryReid's:
    image: bestzwei/HarryReid's:latest
    container_name: HarryReid's
    ports:
      - "8899:80"
    environment:
      - PASSWORD=111111
...
要为您的 HarryReid's 实例添加密码保护，可以在部署平台上设置环境变量：
...
HarryReid's 支持标准的苹果 CMS V10 API 格式。添加自定义 API 时需遵循以下格式：
...
HarryReid's 仅作为视频搜索工具，不存储、上传或分发任何视频内容。所有视频均来自第三方 API 接口提供的搜索结果。如有侵权内容，请联系相应的内容提供方。
